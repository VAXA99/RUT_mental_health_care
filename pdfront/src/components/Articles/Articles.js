...
export default function Articles() {
    ...
    <div className="container main">
        ...
        <div className="form main article">
            <div className="img__position"><img src="/img/Rectangle 183.png" alt="" width="100%" height="100%"/></div>
            <div className="form__page__title">Как не потерять себя</div>
        </div>
        <div className="form main article">
            <div className="img__position"><img src="/img/Rectangle 183 (1).png" alt="" width="100%" height="100%"/></div>
